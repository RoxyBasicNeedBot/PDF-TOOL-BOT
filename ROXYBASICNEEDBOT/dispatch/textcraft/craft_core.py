...
@RoxyBot.on_callback_query(filters.regex("^t2p.*:$"))
async def text_to_pdf(bot, callbackQuery):
    try:
        ...
        pdf.set_title("RoxyBasicNeedBot")
        pdf.set_subject(
            "pdf created using roxybasicneedbot open source Telegram Pdf Bot\n\nContact RoxyBasicNeedBot: telegram.dog/roxybasicneedbot ❤"
        )
        pdf.set_author("https://github.com/RoxyBasicNeedBot")
        pdf.set_producer("by roxybasicneedbot@gmail.com")
